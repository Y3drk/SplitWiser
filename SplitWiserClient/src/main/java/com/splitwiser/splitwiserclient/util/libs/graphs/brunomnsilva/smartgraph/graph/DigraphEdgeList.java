 ...
 */
package com.splitwiser.splitwiserclient.util.libs.graphs.brunomnsilva.smartgraph.graph;
...
//            throw new InvalidEdgeException("There's already an edge with this element.");
//        }
        //disabled cause edges can have the same labels -> ISSUE, Edges with same keys delete themselves, and the keys are the "labels"
